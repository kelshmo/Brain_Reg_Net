...
METADATA_QC_ACC = downloadFile_version(METADATA_QC_ACC_ID, version = 9) %>% 
...
METADATA = METADATA_QC_ACC %>%
  ...
  dplyr::mutate(LibraryBatch = forcats::fct_explicit_na(LibraryBatch, na_level="Missing"))
...
FactorCovariates <- c("Institution", "Reported_Gender", "LibraryBatch", "Dx", "FlowcellBatch")
...
CQN.GENE_EXPRESSION = cqn(round(NEW.COUNTS), 
